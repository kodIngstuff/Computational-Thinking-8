...
answer = input("On a sunny day would you rather A) play video games, B) go outside to a historical monument, C) go to your favorite hamburger stand,D) dance in the streets, E) salute King Charles III, or Feede) hang out at the beach\n")
if answer == "A":
    japan_points += 1
    hawaii_points -=1
elif answer == "B":
